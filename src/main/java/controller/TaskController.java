     ...
     public List<Task> getAll(int idProject) { //pega todas as tarefas do projeto X
         ...
         List<Task> tasks = new ArrayList<Task>();
           try {
            ...
            statement = setInt(1, idProject); //seta um valor, mudando o primeiro ? para o valor do taskId
            resultSet = statement.executeQuery(); //devolve a resposta do select do BD
            ...
            while(resultSet.next()) {
                ...
                tasks.add(task); //coloca a tarefa dentro da lista 
